...
{
  [Guid(ServiceLibraryProjectGuidString)]
  public class ServiceLibraryProjectFlavour : FlavoredProjectBase //, IVsProjectFlavorCfgProvider
  {
    public const string ServiceLibraryProjectGuidString = "2D67DBF9-F18F-4525-B30B-CC32EED8E261";
    ...
    public ServiceLibraryProjectFlavour(AfxPackage package)
    {
      Package = package;
    }
    ...
    //    // Add the ServiceLibrary property page.
    ...
    //  ServiceLibraryProjectFlavorCfg configuration = new ServiceLibraryProjectFlavorCfg();
